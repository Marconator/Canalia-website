            ...
            <section className="gradient-bg text-white section-padding">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <button className="btn-primary bg-tertiary text-primary hover:bg-opacity-90">
                            Comenzar Ahora
                        </button>
            ...
            <section id="contacto" className="section-padding gradient-bg text-white">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-column gap-4 justify-center items-center">
                        <button className="btn-primary bg-tertiary text-primary hover:bg-opacity-90 text-lg px-12 py-4">
